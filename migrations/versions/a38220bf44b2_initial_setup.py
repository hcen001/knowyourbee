...
Revision ID: a38220bf44b2
Revises: 
Create Date: 2018-03-30 16:00:29.942541
...
def upgrade():
    ...
    sa.Column('email', sa.String(length=128), server_default='someone@xample.org', nullable=False),
    sa.Column('phone', sa.String(length=128), server_default='N/A', nullable=False),
    sa.Column('_Partner__institution', sa.String(length=256), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email')
    )
    ...
    sa.Column('date_created', sa.DateTime(), nullable=True),
    sa.Column('date_updated', sa.DateTime(), nullable=True),
    sa.Column('package_id', app.mod_util.utils.GUID(), nullable=False),
    ...
    sa.Column('sender_source_id', sa.String(length=64), nullable=True),
    ...
    sa.Column('date_created', sa.DateTime(), nullable=True),
    sa.Column('date_updated', sa.DateTime(), nullable=True),
    sa.Column('sample_id', app.mod_util.utils.GUID(), nullable=False),
    ...
    sa.Column('additional_gps_info', sa.String(length=1024), nullable=False),
    ...
    sa.Column('date_created', sa.DateTime(), nullable=True),
    sa.Column('date_updated', sa.DateTime(), nullable=True),
    sa.Column('specimen_id', app.mod_util.utils.GUID(), nullable=False),
